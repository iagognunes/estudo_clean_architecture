...
import 'package:estudo_clean_architecture/core/network/network_info.dart';
...
import 'package:estudo_clean_architecture/features/number_trivia/data/repositories/number_trivia_repository_impl.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<NumberTriviaRemoteDataSource>(
    () => NumberTriviaRemoreDataSourceImpl(client: sl()),
  );
